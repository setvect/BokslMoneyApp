      ...
      <tbody>
        <tr v-for="(item, index) in itemList" :key="item.categorySeq">
          ...
          <td style="text-align: left;">
            <a href="javascript:" @click="changeOrder(itemList[index - 1].categorySeq, item.categorySeq)" :style="{visibility: isUpable(index) ? '' : 'hidden'}">
              <i class="fa fa-arrow-up"></i>
            </a>
            <a href="javascript:" @click="changeOrder(item.categorySeq, itemList[index + 1].categorySeq)" :style="{visibility: isDownable(index) ? '' : 'hidden'}">
